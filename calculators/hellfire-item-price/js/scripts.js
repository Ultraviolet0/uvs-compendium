...
prefx[43] = new Affx("Useless", 5, "-100-100%,damage", "--WTB-", true, 0, 0, -8);
prefx[44] = new Affx("Bent", 3, "-75-50% damage", "--WTB-", true, 0, 0, -4);
prefx[45] = new Affx("Weak", 1, "-45-25% damage", "--WTB-", true, 0, 0, -3);
prefx[46] = new Affx("Jagged", 4, "20-35,% damage", "--WTB-", false, 250, 200, 3);
prefx[47] = new Affx("Deadly", 6, "36-50,% damage", "--WTB-", false, 500, 200, 4);
prefx[48] = new Affx("Heavy", 9, "51-65,% damage", "--WTB-", false, 750, 200, 5);
prefx[49] = new Affx("Vicious", 12, "66-80,% damage", "--WTB-", false, 1000, 450, 8);
prefx[50] = new Affx("Brutal", 16, "81-95,% damage", "--WTB-", false, 1500, 450, 10);
prefx[51] = new Affx("Massive", 20, "96-110,% damage", "--WTB-", false, 2000, 450, 13);
...
prefx[75] = new Affx("Angel's", 15, "+1 spell levels", "---T--", false, 25000, 0, 2);
prefx[76] = new Affx("Arch-Angel's", 25, "+2 spell levels", "---T--", false, 50000, 0, 3);
...
suffx[1] = new Affx("Weakness", 1, "-5-1 strength", "ASWTBJ", true, 0, 0, -2);
suffx[2] = new Affx("Strength", 1, "1-5, strength", "ASWTBJ", false, 200, 800, 2);
...
suffx[15] = new Affx("Atrophy", 1, "-5-1 dexterity", "ASWTBJ", true, 0, 0, -2);
suffx[16] = new Affx("Dexterity", 1, "1-5, dexterity", "ASWTBJ", false, 200, 800, 2);
...
suffx[20] = new Affx("Perfection", 23, "21-30, dexterity", "----BJ", false, 5200, 4800, 10);
suffx[21] = new Affx("Illness", 3, "-10-6 vitality", "ASW-BJ", true, 0, 0, -3);
suffx[22] = new Affx("Disease", 1, "-5-1 vitality", "ASWTBJ", true, 0, 0, -2);
suffx[23] = new Affx("Vitality", 1, "1-5, vitality", "ASWTBJ", false, 200, 800, 2);
...
suffx[28] = new Affx("Trouble", 12, "-10-6 all attributes", "ASWTBJ", true, 0, 0, -10);
suffx[29] = new Affx("the Pit", 5, "-5-1 all attributes", "ASWTBJ", true, 0, 0, -5);
suffx[30] = new Affx("the Sky", 5, "1-3, all attributes", "ASWTBJ", false, 800, 3200, 5);
suffx[31] = new Affx("the Moon", 11, "4-7, all attributes", "ASWTBJ", false, 4800, 3200, 10);
...
suffx[45] = new Affx("Quality", 2, "1-2, damage", "--WTB-", false, 100, 100, 2);
suffx[46] = new Affx("Maiming", 7, "3-5, damage", "--WTB-", false, 1300, 200, 3);
...
suffx[77] = new Affx("Speed", 19, "faster attack", "--WT--", false, 8000, 0, 8);
...
suffx[84] = new Affx("Sturdiness", 1, "-26-75% durability", "ASWT--", false, 100, 0, 2);
suffx[85] = new Affx("Craftsmanship", 6, "51-100% durability", "ASWT--", false, 200, 0, 2);
suffx[86] = new Affx("Structure", 12, "101-200% durability", "ASWT--", false, 300, 0, 2);
suffx[87] = new Affx("Many", 3, "100% durability", "----B-", false, 750, 0, 2);
suffx[88] = new Affx("Plenty", 7, "200% durability", "----B-", false, 1500, 0, 3);
suffx[89] = new Affx("the Ages", 25, "indestructible", "ASWT--", false, 600, 0, 5);
...
spel.push(new Spel("Lightning Wall", 2, "8-16", true, 80));
spel.push(new Spel("Magi", 20, "15-30", true, 40));
spel.push(new Spel("Mana", 5, "12-24", true, 10));
spel.push(new Spel("Reflect", 3, "8-12", true, 40));
spel.push(new Spel("Ring of Fire", 5, "8-16", true, 80));
spel.push(new Spel("Search", 3, "8-12", true, 40));
spel.push(new Spel("Warp", 3, "8-12", true, 40));
...
function isSpellOption(option) {
  return option && String(option.value).indexOf("spell:") === 0;
}

function spellIndexFromOption(option) {
  return parseInt(String(option.value).replace("spell:", ""), 10);
}

function selectedSuffixIsSpell() {
  return document.SelectItm.Clas.options[document.SelectItm.Clas.selectedIndex].text == "Staff" &&
    isSpellOption(document.SelectItm.Suffx.options[document.SelectItm.Suffx.selectedIndex]);
}

function selectedSuffixIsStaffAffix() {
  return document.SelectItm.Clas.options[document.SelectItm.Clas.selectedIndex].text == "Staff" &&
    document.SelectItm.Suffx.selectedIndex > 0 &&
    !selectedSuffixIsSpell();
}

// Source radio indices. Keep these in sync with the calculator form markup.
var ADRIA_SOURCE = 0;
var GRIS_SOURCE = 1;
var WIRT_SOURCE = 2;
var SALE_SOURCE = 3;
...
function setSourceState(index, elementId, enabled) {
  var sourceLabel = document.getElementById(elementId);
  if (sourceLabel) {
    sourceLabel.classList.toggle("is-disabled", !enabled);
  }
  document.SelectItm.Source[index].disabled = !enabled;
}

function enableSource(index, elementId) {
  setSourceState(index, elementId, true);
}

function disableSource(index, elementId) {
  setSourceState(index, elementId, false);
}
...
function updateClas() {
  ...
  if (iClas == "Helm") {
    ...
    enableSource(SALE_SOURCE, "Sale");
    document.SelectItm.Source[SALE_SOURCE].checked = true;
    return;
  }
  ...
  if (prefxS == "None") {
    ...
    if (document.SelectItm.Clas.options[document.SelectItm.Clas.selectedIndex].text == "Staff") {
      if (prefxS.name == "Plentiful" || prefxS.name == "Bountiful") {
        for (i = 0; i <= document.SelectItm.Suffx.options.length - 1; i++) {
          document.SelectItm.Suffx.options[i].style.color = isSpellOption(document.SelectItm.Suffx.options[i]) ? "#A0A5C8" : "#4C4C4C";
        }
      }
      else {
        document.SelectItm.Suffx.options[0].style.color = "#A0A5C8";
        for (i = 1; i <= document.SelectItm.Suffx.options.length - 1; i++) {
          if (isSpellOption(document.SelectItm.Suffx.options[i])) {
            document.SelectItm.Suffx.options[i].style.color = "#A0A5C8";
            continue;
          }
...
function updateSuffx() {
  ...
  if (selectedSuffixIsSpell()) {
    var suffxS = spel[spellIndexFromOption(document.SelectItm.Suffx.options[document.SelectItm.Suffx.selectedIndex])];
  }
  else {
...
function selectedHasCursedAffix(prefxS, suffxS) {
  return (prefxS != "None" && prefxS.cursd) ||
    (suffxS != "None" && !selectedSuffixIsSpell() && suffxS.cursd);
}

function selectedHasOnlyCursedAffixes(prefxS, suffxS) {
  var hasAffix = false;
  var hasNonCursedAffix = false;

  if (prefxS != "None") {
    hasAffix = true;
    if (!prefxS.cursd) {
      hasNonCursedAffix = true;
    }
  }

  if (suffxS != "None" && !selectedSuffixIsSpell()) {
    hasAffix = true;
    if (!suffxS.cursd) {
      hasNonCursedAffix = true;
    }
  ...
  return hasAffix && !hasNonCursedAffix;
}
...
function updateSource() {
  if (currentItemClass() != "Unique") {
    ...
    if (selectedHasCursedAffix(prefxS, suffxS)) {
      disableSource(ADRIA_SOURCE, "Adria");
      disableSource(GRIS_SOURCE, "Gris");
      disableSource(WIRT_SOURCE, "Wirt");
      enableSource(SALE_SOURCE, "Sale");
    ...
    // Adria only matters for staves in this calculator.
    if (itemClass != "Staff") {
      disableSource(ADRIA_SOURCE, "Adria");
    }

    //rules for the prefix, non-staffs
    if (prefxS != "None" && itemClass != "Staff") {
      if (prefxS.cursd) {
        disableSource(GRIS_SOURCE, "Gris");
        disableSource(WIRT_SOURCE, "Wirt");
      }
    ...
    if (itemClass == "Staff") {
      ...
      // Adria sells charged staves, but not spells above qlvl 16.
      // Keep the original base item ilvl > 16 Adria staff cap too.
      if (selectedSuffixIsSpell() && suffxS.qlvvl > 16) {
        disableSource(ADRIA_SOURCE, "Adria");
      }

      // High-qlvl staff affixes cannot be sold by normal staff vendors.
      // Adria can still sell charged staves with prefixes up to qlvl 32.
      if (prefxS != "None" && prefxS.qlvvl > 30) {
        if (!(selectedSuffixIsSpell() && prefxS.qlvvl <= 32)) {
          disableSource(ADRIA_SOURCE, "Adria");
        }
      ...
      if (selectedSuffixIsSpell()) {
        if (suffxS.qlvvl > 16 || prefxS.qlvvl > 32) {
          disableSource(ADRIA_SOURCE, "Adria");
        }
      }
    }
    ...
    //rules for the suffix, non-staffs
    if (suffxS != "None" && itemClass != "Staff") {
      if (suffxS.cursd) {
        disableSource(GRIS_SOURCE, "Gris");
        disableSource(WIRT_SOURCE, "Wirt");
      }
    ...
    //Hellfire Wirt can sell staff prefixes qlvl 1-60 with spell charges qlvl 1-20,
    //so do not apply this affix-pair rule to spell-charge suffixes.
    if (prefxS != "None" && suffxS != "None" && !selectedSuffixIsSpell()) {
      var qlvvlMin = Math.min(prefxS.qlvvl, suffxS.qlvvl);
      var qlvvlMax = Math.max(prefxS.qlvvl, suffxS.qlvvl);
...
function reset() {
  ...
  enableSource(ADRIA_SOURCE, "Adria");
  enableSource(GRIS_SOURCE, "Gris");
  document.SelectItm.Source[GRIS_SOURCE].checked = true;
  enableSource(WIRT_SOURCE, "Wirt");
  enableSource(SALE_SOURCE, "Sale");
...
function validat() {
  ...
  if (document.SelectItm.Clas.options[document.SelectItm.Clas.selectedIndex].text == "Staff") {
    ...
    if (prefxS != "None") {
      if ((prefxS.name == "Plentiful" || prefxS.name == "Bountiful") && !selectedSuffixIsSpell()) {
        return false;
      }
    }
    if (prefxS != "None" && selectedSuffixIsStaffAffix()) {
...
function calcPrice() {
  ...
  //calculate price
  if (document.SelectItm.Clas.options[document.SelectItm.Clas.selectedIndex].text == "Unique") {
    price = Math.floor(unique[document.SelectItm.Bse.selectedIndex].price / 4);
  ...
  if (
    document.SelectItm.Source[SALE_SOURCE].checked == true &&
    selectedHasOnlyCursedAffixes(prefxS, suffxS)
  ) {
    document.getElementById("Price").firstChild.nodeValue = "1";
    return;
  }
...
function initHellfirePriceCalculator() {
  var form = document.forms.SelectItm;

  if (!form) {
    return;
  }

  form.Clas.addEventListener("change", function () {
    updateClas();
    calcPrice();
  });

  form.Prefx.addEventListener("change", function () {
    updatePrefx();
    calcPrice();
  });

  form.Bse.addEventListener("change", function () {
    updateSource();
    calcPrice();
  });

  form.Suffx.addEventListener("change", function () {
    updateSuffx();
    calcPrice();
  });
...
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", initHellfirePriceCalculator);
}
else {
  initHellfirePriceCalculator();
}

...
function SetPremiumOutput(theForm, outputId, value) {
  var output = document.getElementById(outputId);

  if (!output && theForm && theForm.elements) {
    output = theForm.elements[outputId];
  }
  ...
  for (i = 1, j = 1; i <= premax; i++) {
    if (sufparm & prefixx[i].equip.parm || (suflvl == 0)) {
      if (((prefixx[i].equip.parm >> bastype) & 1) || (baslvl == 0)) {
        if ((suflvl == 0) || ((prefixx[i].level * 2 + 1 >= suflvl) && (suflvl * 2 + 1 >= prefixx[i].level)) || ((prefixx[i].level >= 25) && (suflvl >= 25)) || ((selsuff > 95) && (selsuff <= 121))) {
  ...
  for (i = 1, j = 1; i <= sufmax; i++) {
    if (preparm & suffixx[i].equip.parm || (prelvl == 0)) {
      if (((suffixx[i].equip.parm >> bastype) & 1) || (baslvl == 0)) {
        if ((prelvl == 0) || ((suffixx[i].level * 2 + 1 >= prelvl) && (prelvl * 2 + 1 >= suffixx[i].level)) || ((suffixx[i].level >= 25) && (prelvl >= 25)) || ((bastype % 3 == 0) && ((i > 95) && (i <= 121)))) {
...
function Display(theForm, SelBasee, SelPref, SelSuff) {
  ...
  dsp1 += grisdsp + wirtdsp + adradsp + normdsp + maredsp + helldsp;
  SetPremiumOutput(theForm, "display1", dsp1);
  SetPremiumOutput(theForm, "display2", dsp2pref + dsp2suff + dsp2base);
  dsp3 = "";
  ...
  SetPremiumOutput(theForm, "display3", dsp3);
...
//-- Hellfire-only Unique and Quest Item Rows --------------
basee[147] = new MakeBasee("Xorine's Ring", new GetKind(7, "Unique"), 8, 8000, "Indestructible");
basee[148] = new MakeBasee("Karik's Ring", new GetKind(7, "Unique"), 8, 8000, "Indestructible");
basee[149] = new MakeBasee("Mercurial Ring", new GetKind(7, "Unique"), 8, 8000, "Indestructible");
basee[150] = new MakeBasee("Giant's Knuckle", new GetKind(7, "Unique"), 8, 8000, "Indestructible");
basee[151] = new MakeBasee("Ring of Magma", new GetKind(7, "Unique"), 8, 8000, "Indestructible");
basee[152] = new MakeBasee("Ring of the Mystics", new GetKind(7, "Unique"), 8, 8000, "Indestructible");
basee[153] = new MakeBasee("Ring of Thunder", new GetKind(7, "Unique"), 8, 8000, "Indestructible");
basee[154] = new MakeBasee("Gladiator's Ring", new GetKind(7, "Unique"), 10, 10000, "Indestructible");
basee[155] = new MakeBasee("Amulet of Warding", new GetKind(7, "Unique"), 12, 30000, "Indestructible");
basee[156] = new MakeBasee("Acolyte's Amulet", new GetKind(7, "Unique"), 10, 10000, "Indestructible");
basee[157] = new MakeBasee("Auric Amulet", new GetKind(7, "Unique"), 0, 100, "Indestructible    Quest Item");
basee[158] = new MakeBasee("Diamondedge", new GetKind(7, "Unique"), 17, 42000, "Damage: 2 - 10    DUR:  10    Required:  STR 20  DEX 30");
basee[159] = new MakeBasee("Eater of Souls", new GetKind(7, "Unique"), 23, 42000, "Damage: 8 - 16    Indestructible    Required:  STR 65");
basee[160] = new MakeBasee("Shirotachi", new GetKind(7, "Unique"), 21, 36000, "Damage: 10 - 20    DUR: 100    Required:  STR 75");
basee[161] = new MakeBasee("Blitzen", new GetKind(7, "Unique"), 13, 30000, "Damage: 3 - 6    Indestructible    Required:  STR 25  DEX 40");
basee[162] = new MakeBasee("Flambeau", new GetKind(7, "Unique"), 11, 30000, "Damage: 3 - 6    Indestructible    Required:  STR 25  DEX 40");
basee[163] = new MakeBasee("Gnat Sting", new GetKind(7, "Unique"), 15, 30000, "Damage: 2 - 5    Indestructible    Required:  STR 20  DEX 35");
basee[164] = new MakeBasee("Thunderclap", new GetKind(7, "Unique"), 13, 30000, "Damage: 5 - 9    Indestructible    Required:  STR 40");
basee[165] = new MakeBasee("Armor of Gloom", new GetKind(7, "Unique"), 25, 200000, "Armor Class: 225        No Strength Requirement");
basee[166] = new MakeBasee("Bone Chain Armor", new GetKind(7, "Unique"), 13, 36000, "Armor Class: 40        DUR:  55    Required:  STR 25");
basee[167] = new MakeBasee("Bovine Plate", new GetKind(7, "Unique"), 0, 400, "Armor Class: 150        Indestructible    Quest Item");
basee[168] = new MakeBasee("Demon Plate Armor", new GetKind(7, "Unique"), 25, 80000, "Armor Class: 80        DUR:  90    Required:  STR 90");
...
//-- Hellfire-only Unique and Quest Item Effects -----------
uniq[77] = new MakeUniq("Ring", 8, 60, "qlvl: 8   -30 to Strength   +60 to Magic");
uniq[78] = new MakeUniq("Ring", 8, 60, "qlvl: 8   -30 to Magic   +60 to Vitality");
uniq[79] = new MakeUniq("Ring", 8, 60, "qlvl: 8   -30 to Strength   +60 to Dexterity");
uniq[80] = new MakeUniq("Ring", 8, 60, "qlvl: 8   +60 to Strength   -30 to Dexterity");
uniq[81] = new MakeUniq("Ring", 8, 60, "qlvl: 8   Resist Magic -30%   Resist Fire +60%   Resist Lightning -30%");
uniq[82] = new MakeUniq("Ring", 8, 60, "qlvl: 8   Resist Magic +60%   Resist Fire -30%   Resist Lightning -30%");
uniq[83] = new MakeUniq("Ring", 8, 60, "qlvl: 8   Resist Magic -30%   Resist Fire -30%   Resist Lightning +60%");
uniq[84] = new MakeUniq("Ring", 10, 60, "qlvl: 10   40% of base Life moved to Mana");
uniq[85] = new MakeUniq("Amulet", 12, 60, "qlvl: 12   Hit Points -100   Resist All +40%");
uniq[86] = new MakeUniq("Amulet", 10, 60, "qlvl: 10   50% of base Mana moved to Life");
uniq[87] = new MakeUniq("Amulet", 0, 0, "Quest Item   Allows you to carry piles of 10,000 gold");
uniq[88] = new MakeUniq("Long Sword", 17, 60, "qlvl: 17   Armor Class: 10   Resist Lightning +50%   Chance to Hit +50%\n    Damage: +100%   Altered Durability");
uniq[89] = new MakeUniq("Two-Handed Sword", 23, 60, "qlvl: 23   Hit Points +50   Hit Steals 5% Life   Hit Steals 5% Mana\n    Causes continuous damage when worn   Indestructible");
uniq[90] = new MakeUniq("Great Sword", 21, 60, "qlvl: 21   One Handed Sword   Fastest Attack   Penetrates target armor\n    Lightning Hit Damage: 6");
uniq[91] = new MakeUniq("Composite Bow", 13, 60, "qlvl: 13   Lightning Damage: 10 - 15   Unusual Item Damage (0)\n    Indestructible");
uniq[92] = new MakeUniq("Composite Bow", 11, 60, "qlvl: 11   Fireball Damage: 15 - 20   Unusual Item Damage (0)\n    Indestructible");
uniq[93] = new MakeUniq("Hunter's Bow", 15, 60, "qlvl: 15   Multiple Arrows   Unusual Item Damage (1 - 2)\n    Quick Attack   Indestructible");
uniq[94] = new MakeUniq("War Hammer", 13, 60, "qlvl: 13   +20 to Strength   Resist Lightning +30%   Charged Bolt Damage: 3 - 6\n    +20% Light Radius   Indestructible");
uniq[95] = new MakeUniq("Full Plate Mail", 25, 60, "qlvl: 25   Armor Class: 225   All Resistances = 0%\n    -20% Light Radius   No Strength Requirement");
uniq[96] = new MakeUniq("Chain Mail", 13, 60, "qlvl: 13   Armor Class: 40   Armor Class: 60 vs. Undead");
uniq[97] = new MakeUniq("Bovine Plate", 0, 0, "Quest Item   Armor Class: 150   Mana -50   Resist All +30%\n    Spells Are Decreased 2 Levels   +50% Light Radius   Indestructible");
uniq[98] = new MakeUniq("Full Plate Mail", 25, 60, "qlvl: 25   Armor Class: 80   Armor Class: 120 vs. Demons");


//-- Page Bootstrap ---------------------------------------
function InitPremiumCheckerPage() {
  var form = document.forms.premium;

  if (!form) {
    return;
  }

  var prefixSelect = form.elements.prefixx;
  var baseSelect = form.elements.basee;
  var suffixSelect = form.elements.suffixx;
  var priceModeSelect = form.elements.calcprice;
  var resetButton = document.getElementById("premium-reset");
...
if (typeof window !== "undefined") {
  window.addEventListener("DOMContentLoaded", InitPremiumCheckerPage);
}
